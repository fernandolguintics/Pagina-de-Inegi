...
namespace InegiWeb
{
    public partial class VerPDFEvidenciasServicio : System.Web.UI.Page
    {
        ...
        {
            string getPdf = "select ImageInstalacion from ReportesServicios inner join OrdenesCompraServicios on ReportesServicios.IdOrdenCompra = OrdenesCompraServicios.IdOrdenCompraServicio where IdReporteServicios = @Id";
