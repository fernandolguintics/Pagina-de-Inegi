...
namespace InegiWeb
{
    public partial class VerPDFOrdenCompra : System.Web.UI.Page
    {
        ...
        {
            string getPdf = "select TicketdeCompra from Reportes inner join OrdenCompra on Reportes.IdOrdenCompra = OrdenCompra.IdOrdenCompra where IdReporte=@Id";
